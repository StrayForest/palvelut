...
class ProviderClaimAdmin(admin.ModelAdmin):
    list_display = ("provider", "claimed_by", "status", "created_at", "reviewed_by", "reviewed_at")
    list_filter = ("status",)
    search_fields = ("provider__display_name", "provider__legal_name", "claimed_by__username")
...
class VerificationCheckAdmin(admin.ModelAdmin):
    ...
    search_fields = ("provider__display_name", "provider__legal_name", "source_url")
