...
@transaction.atomic
def approve_claim(*, claim: ProviderClaim, actor) -> ProviderClaim:  # type: ignore[no-untyped-def]
...
@transaction.atomic
def reject_claim(*, claim: ProviderClaim, actor) -> ProviderClaim:  # type: ignore[no-untyped-def]
