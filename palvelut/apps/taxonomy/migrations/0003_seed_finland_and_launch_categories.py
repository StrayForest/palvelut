...
CATEGORIES = {
    ...
    "massage-physiotherapy": {
        ...
        "labels": {
            "ru": "Массаж и физиотерапия",
            "fi": "Hieronta ja fysioterapia",
...
def seed_taxonomy(apps, schema_editor):
    ...
    finland, _ = Country.objects.update_or_create(
        code="FI", defaults={"name": "Finland"}
    )
    regions = {}
