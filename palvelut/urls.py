...
urlpatterns = [
    ...
    path("palvelut/account/password-reset/done/", SecurePasswordResetDoneView.as_view(), name="account-password-reset-done"),
    path("palvelut/account/password-reset/<uidb64>/<token>/", SecurePasswordResetConfirmView.as_view(), name="account-password-reset-confirm"),
    path("palvelut/account/password-reset/complete/", SecurePasswordResetCompleteView.as_view(), name="account-password-reset-complete"),
    path("palvelut/account/mfa/", staff_mfa, name="staff-mfa"),
    path("palvelut/account/claims/", claim_candidates, name="account-claim-list"),
    path("palvelut/account/claims/<uuid:provider_id>/", claim_provider, name="account-claim-provider"),
    path("palvelut/account/profile/", workspace, name="provider-workspace"),
    path("palvelut/account/profile/<uuid:provider_id>/", edit_profile, name="provider-workspace-edit"),
    path("palvelut/account/profile/<uuid:provider_id>/media/", upload_profile_media, name="provider-workspace-media-upload"),
    path("palvelut/account/profile/<uuid:provider_id>/preview/", preview_profile, name="provider-workspace-preview"),
    path("palvelut/account/profile/<uuid:provider_id>/submit/", submit_profile, name="provider-workspace-submit"),
    path("palvelut/account/moderation/<uuid:case_id>/", provider_case, name="provider-moderation-case"),
    path("palvelut/staff/claims/", staff_claim_list, name="staff-claim-list"),
    path("palvelut/staff/claims/<uuid:provider_id>/", staff_claim_review, name="staff-claim-review"),
    path("palvelut/staff/moderation/", staff_case_list, name="staff-moderation-cases"),
    path("palvelut/staff/moderation/<uuid:case_id>/", staff_case, name="staff-moderation-case"),
    ...
    path("palvelut/<str:locale>/professionals/<uuid:provider_id>/report/", report_provider, name="report-provider"),
    path("palvelut/report/<str:token>/", report_status, name="report-status"),
    path("palvelut/<str:locale>/professionals/<slug:slug>/", cached_profile, name="provider-profile"),
    path("palvelut/<str:locale>/go/<uuid:provider_id>/<str:channel>/", contact_redirect, name="contact-redirect"),
    path("palvelut/<str:locale>/<slug:city>/<slug:category>/", cached_city_category, name="city-category"),
]
