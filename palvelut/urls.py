...
urlpatterns = [
    ...
    path(
        "palvelut/account/moderation/<uuid:case_id>/",
        provider_case,
        name="provider-moderation-case",
    ),
    ...
    path(
        "palvelut/staff/moderation/",
        staff_case_list,
        name="staff-moderation-cases",
    ),
    path(
        "palvelut/staff/moderation/<uuid:case_id>/",
        staff_case,
        name="staff-moderation-case",
    ),
    ...
    path(
        "palvelut/<str:locale>/professionals/<uuid:provider_id>/report/",
        report_provider,
