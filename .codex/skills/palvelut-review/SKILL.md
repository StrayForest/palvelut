...
1. Identify the task/correction acceptance contract and exact commit under review.
...
7. Mark PASS only when every applicable gate passes on the exact commit. Otherwise remain BLOCKED and state the smallest corrective action.

Run release review in a fresh session without implementer rationale. A self-review is diagnostic only; any new commit invalidates prior review evidence.
