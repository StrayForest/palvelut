...
class WorkflowSecurityContractTests(unittest.TestCase):
    ...
    def test_compose_images_are_immutable_and_version_documented(self) -> None:
        ...
        image_indexes = [
            index for index, line in enumerate(lines) if re.match(r"^\s+image:\s+", line)
        ]
